...
export default function VideoForgePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center max-w-3xl mx-auto">
      ...
      <h1 className="text-5xl font-bold tracking-tight mb-6">VideoForge</h1>
      
      <p className="text-xl text-muted-foreground leading-relaxed mb-12">
        AI-powered video creation studio. Turn scripts into long-form videos, shorts, and reels automatically. Let AI handle the editing, captions, and b-roll.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left w-full max-w-2xl mb-12">
        {[
          ...
          "Smart clipping for Shorts/Reels",
      ...
      <Button 
        ...
        onClick={() => toast.success("You'll be notified when VideoForge launches!")}
      >
