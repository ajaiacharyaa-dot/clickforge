            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <div className="flex items-center gap-3">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${platform.connected ? 'bg-background shadow-sm' : 'bg-muted'}`}>
                  <PlatformIcon platform={platform.id} className={`w-6 h-6 ${platform.connected ? 'text-primary' : 'text-muted-foreground'}`} />
                </div>
                <div>
            ...
            <CardContent className="pt-4">
              {platform.connected ? (
                ...
                <div className="space-y-4">
                  ...
                  <Button className="w-full shadow-sm bg-gradient-viral text-white hover:opacity-90 border-0" onClick={() => handleConnect(platform.name)}>
