...
export default function AgentForgePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center max-w-3xl mx-auto">
      ...
      <h1 className="text-5xl font-bold tracking-tight mb-6">AgentForge</h1>
      
      <p className="text-xl text-muted-foreground leading-relaxed mb-12">
        Build and deploy your own autonomous AI workforce. Create custom agents for research, community management, sales outreach, and automated content publishing.
      </p>
      ...
      <Button 
        ...
        onClick={() => toast.success("You'll be notified when AgentForge launches!")}
      >
