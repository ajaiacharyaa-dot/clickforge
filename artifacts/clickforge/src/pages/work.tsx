...
export default function WorkForgePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center max-w-3xl mx-auto">
      ...
      <h1 className="text-5xl font-bold tracking-tight mb-6">WorkForge</h1>
      
      <p className="text-xl text-muted-foreground leading-relaxed mb-12">
        The creator economy opportunity marketplace. Find high-paying jobs, hire elite talent, sell freelance services, and build hybrid human-AI teams.
      </p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left w-full max-w-2xl mb-12">
        {[
          "AI-matched job boards",
          "Freelance service storefronts",
          "Talent portfolio hosting",
      ...
      <Button 
        ...
        onClick={() => toast.success("You'll be notified when WorkForge launches!")}
      >
