...
export default function LearnForgePage() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 text-center max-w-3xl mx-auto">
      ...
      <h1 className="text-5xl font-bold tracking-tight mb-6">LearnForge</h1>
      
      <p className="text-xl text-muted-foreground leading-relaxed mb-12">
        The ultimate AI education platform. Level up your skills with personalized learning paths, interactive AI tutors, and real-time progress tracking.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left w-full max-w-2xl mb-12">
        {[
          ...
          "Interactive coding & design lessons",
      ...
      <Button 
        ...
        onClick={() => toast.success("You'll be notified when LearnForge launches!")}
      >
